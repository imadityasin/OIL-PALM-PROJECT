...
<head>
    ...
    <link rel="stylesheet" href="./assets/css/SuccessStories.css">
...
<body class="home">
    ...
    <div class="container" >
        <div class="box">
            <img src="assets/images/shajan.jpg" width="180px;" height="200px;" alt="Farmer Image">
            <br>
            <br>
            <h4><b>SHRI CHILUKURI UPENDRA REDDY</b></h4>
            <p>Kallupalathinkal, Kottayam Kerala</p>
            <p> i. Area of Cultivation : 45 ha<br>
                ii. Seedlings : 6500 Nos<br>
                iii. Variety : Tenera<br>
                iv. Plant Population : 6500 <br>
                v. Fertilizer application : Urea,Potash,Rock phosphate<br>
                vi. Yield : 9 mt per Ha
            </p>
            <p><b>Farmers experience : </b>He has oil palm cultivation in 90 acres land in Kuttanad area 
                which is a water Iogged area known as "Kariland" where palm maintenance and 
                other allied activities are quite difficult to carry on.
                Yet he is succeeded in oil palm cultivation.</p>
            <a href="javascript:void();" class="readmore-btn">Read More</a>
        </div>

        <div class="box">
            <img src="assets/images/ramadugu.jpg" width="180px;" height="200px;" alt="Farmer Image">
            <br>
            <br>
            
            <h4> <b> SHRI. RAMADUGU SURESH </b> </h4>
            <p>Raghunadhapalem (V), Thirumalayapalem (M),Khammam (D) Telangana</p>
            <p> i. Area of Cultivation : 10.00 acres<br>
                ii. Seedlings : Imported<br>
                iii. Variety  : Tenera<br>
                iv. Plant Population : 570 nos. <br>
                v. Irrigation method : Drip irrigation <br>
                vi. Fertilizer application : Through drip system <br>
                vii. Yield : 10 MTs per acre <br>
                <b>Farmers experience: </b><br>
                Farmer is getting high and sustainable income compared to traditional crops.
        ...
        <div class="box">
            <img src="assets/images/CHACKO.jpg" width="180px;" height="200px;" alt="Farmer Image">
            <br>
            <br>
            
            <h4> <b> N.V CHACKO </b> </h4>
            <p>Edayathyputhen Purayil Kuthattukulam Kerala</p>
            <p> i. Area of Cultivation : 2.7 Ha<br>
                ii. Seedlings : 370 No.<br>
                iii. Variety : Tenera <br>
                iv. Intercropping (if any) : Vegetables <br>
                v. Fertilizer application : Urea,Potash,Rock phosphate<br>
                vi. Yield : 8mt per Ha<br>
                <b>Farmers experience</b>
                N.V Chacko is a progressive oil palm farmer, 
                regularly giving god attention to the palms in his plantation. 
                He is eager to maintain the full population in the plantation by observing the 
                casualty in the area and fill up by using new oil palm seedlings.
            </p>
            <a href="javascript:void();" class="readmore-btn">Read More</a>
        </div>
    </div>
    <div class="container" >
    <div class="box">
            <img src="assets/images/Rao.jpg" width="180px;" height="200px;" alt="Farmer Image">
            <br>
            <br>
            <h4><b>SHRI. BOINA THIRUPATHI RAO</b></h4>
            <p>Utlapalli (V), Annapureddypally (M), Bhadradri Kothagudem (D)Telangana</p>
            <p>
                i. Area of Cultivation : 14.00 acres<br>
                ii. Seedlings : Imported<br>
                iii. Variety : Tenera<br>
                iv. Plant Population : 798 nos. <br>
                v. Intercropping (if any) : Cocoa <br>
                vi. Irrigation method : Drip irrigation <br>
                vii. Fertilizer application : Through drip system <br>
                viii. Through drip system : 12 to 14 MTs per acre <br>
            </p>
            <p>
            <b>Farmers experience :</b>
            Farmer is getting high
        ...
        <div class="box">
            <img src="assets/images/shir.jpg" width="180px;" height="200px;" alt="Farmer Image">
            <br>
            <br>
            <h4><b>SHRI. DONDETI SRINU</b></h4>
            <p>Pindiprolu (V), Thirumalayapalem (M), Khammam (D)Telangana</p>
            <p>
            i. Area of Cultivation : 12.50 acres<br>
            ii. Seedlings : Imported<br>
            iii. Variety : Tenera<br>
            iv. Plant Population : 712 nos.<br>
            v. Irrigation method : Drip irrigation<br>
            vi. Fertilizer application : Through drip system.<br>
            vii. Yield : 9 MTs per acre
            </p>
            <p>
            <b>Farmers experience</b>
            Farmer is getting high
        ...
        <div class="box">
            <img src="assets/images/chowdhary.jpg" width="180px;" height="200px;" alt="Farmer Image">
            <br>
            <br>
            <h4><b>SHRI. KOMMARINA ACHANNA CHOWDARY</b> </h4>
            <p>Anumula (V & M), Nalgonda (D) Telangana</p>
            <p>
            i. Area of Cultivation : 8.00 acres <br>
            ii. Seedlings : Imported<br>
            iii. Variety : Tenera <br>
            iv. Plant Population : 456 nos. <br>
            v. Intercropping (if any) : Cucumber <br>
            vi. Irrigation method : Drip irrigation <br>
            vii. Fertilizer application : Through drip system <br>
            viii. Yield : 8 MTs per acre <br>
            </p>
            <p>
                <b>Farmers experience :</b>
                Farmer is getting
