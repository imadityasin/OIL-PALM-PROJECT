...
<body class="home">
    ...
    <div class="SliderDivParent">
        <div class="slider">
            ...
            <div class="slide">
                <img src="./assets/images/Slider/oil-88.jpg" alt="" class="imgC">
            </div>
            <div class="slide">
                <img src="./assets/images/Slider/oil-66.jpg" alt="" class="imgC">
            </div>
        ...
        <div class="AbtDivmDivChild">
            <div class="AboutPlamMDiv">
                <div class="AbtDiv">
                    ...
                    <br>
                    <p class="AbtDivPTag">Among all perennial crop, Oil palm crop is one of the highest oil yielding crops.
                ...
                <div class="AboutPlamImgDiv">
                    <img src="./assets/images/Slider/oil-88.jpg" alt="" class="imgInroTag">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="mapMDiv">
        <div class="bgnew">
            <p></p>
            <H2 class="mapd"><b>Potential States and Districts</b></h2>
            <br>
            <div class="rowmapDiv">
                <div class="bgmap">
                    <div id="map"></div>
    ...
    <div class="popup">
        ...
        <h4><b>THIS SITE IS UNDER MAINTAINCE </b> <img src="assets/images/under-maintenance.png" width="30" height="30" alt="Maintaince Logo"></a></h4>
    </div>
