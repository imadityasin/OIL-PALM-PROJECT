...
<head>
    ...
    <link rel="stylesheet" href="./assets/css/govtpolicy.css">
...
<body class="home">
                    ...
                    <li>
                        ...
                        <li>
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="#">PachimChamparan</a>
                                </li>
                                <li>
                                    <a href="#">Patna</a>
                                </li>
                                <li>
                                    <a href="#">PurbaChamparan</a>
                                </li>
                                <li>
                                    <a href="#">Purnia</a>
                                </li>
                        ...
                        <li>
                            ...
                            <ul>
                                <li>
                                    <a href="#">East garo Hills</a>
                                </li>
                                <li>
                                    <a href="#">East Khasi Hills</a>
                                </li>
                                <li>
                                    <a href="#">Jaintia Hills</a>
                                </li>
                                <li>
                                    <a href="#">West Khasi Hills</a>
                                </li>
                                <li>
                                    <a href="#">Thoubal</a>
                                </li>
                        ...
                        <li>
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="#">Bhupalapally</a>
                                </li>
                                <li>
                                    <a href="#">Bhandradri Kothagudem</a>
                                </li>
                                <li>
                                    <a href="#">Bhuvangiri</a>
                                </li>
                                ...
                                <li>
                                    <a href="#">Jayashankar</a>
                                </li>
                                <li>
                                    <a href="#">Jagitial</a>
                                </li>
                                <li>
                                    <a href="#">JogulambaGawal</a>
                                </li>
                                <li>
                                    <a href="#">Karimnagar</a>
                                </li>
                                ...
                                <li>
                                    <a href="#">kumarambheem Sifabad</a>
                                </li>
                                <li>
                                    <a href="#">Mahabubabad</a>
                                </li>
                                <li>
                                    <a href="#">Mahabubnagar</a>
                                </li>
                                <li>
                                    <a href="#">Medak</a>
                                </li>
                                ...
                                <li>
                                    <a href="#">Medchal Malkajgiri</a>
                                </li>
                                <li>
                                    <a href="#">Nagar Kurnool</a>
                                </li>
                                <li>
                                    <a href="#">Nalgonda</a>
                                </li>
                        ...
                        <li>
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="#">North Tripura</a>
                                </li>
                                <li>
                                    <a href="#">South Tripura</a>
                                </li>
                                <li>
                                    <a href="#">West Tripura</a>
                                </li>
                            </ul>
                        </li>
                        <li>
  ...
  <!-- Content here -->
    <p>In view of the importance and significance of oil palm cultivation, Department of Agriculture, Cooperation and Farmers Welfare (DAC&FW) had taken up Technology Mission on Oilseeds & Pulses (TMOP) in 1991 - 92 in the potential states.
    ...
    During the 12th Five Year Plan, a new National Mission on Oilseeds and Oil Palm (NMOOP) was launched under 
    which Mini Mission - II (MM - II) was dedicated to oil palm area expansion and productivity increases. MM - II of NMOOP was implemented in 12 States viz; Andhra Pradesh, Telangana, Chhattisgarh, Tamil Nadu, Kerala, Gujarat, Karnataka, Odisha, Mizoram, Nagaland, Assam and Arunachal Pradesh w.e.f. 01.04.2014.</p>
    <p><b>National Mission on Edible Oils - Oil Palm (NMEO-OP)</b> has been launched with the aim to enhance the edible oilseeds production and oils availability in the country by harnessing Oil Palm area expansion, increasing CPO production and to reduce import burden on edible oils.</p>
    <br><p><b>TARGET OF NMEO-OP:
    The target fixed for Oil palm area expansion by 2025-26 under NMEO-Oil palm is as under:
    </b></p>    
    <p>• To increase area of oil palm to 10 lakh hectares from 3.5 lakh ha during 2019-20 by 2025-26 (additional 6.50 lakh ha). The target for general states is 3.22 lakh hectares and 3.28 lakh ha for North Eastern states, with targeted FFB production of 66.00 lakh tonnes.<br>
    • To increase in Crude Palm Oil production from 0.27 lakh tonnes during 2019-20 to
    11.20 lakh tonnes by 2025-26 and 28 lakh tonnes by 2028-29.<br>
    • Increase consumer awareness to maintain consumption level of 19.00 kg/person/annum till 2025-26.
    <br><a href="https://nfsm.gov.in/Guidelines/NMEO-OPGUIEDELINES.pdf" class="link-success" target="_blank"><b>National Mission On Edible Oils<b></a>
</p>
</div>
                    ...
                    <div>
                        <p class="navFooterBottom">
                            <a href="" class="ATagFooterBottom">
                                <b>Home</b>
                            </a> | <a href="/Dashboard" class="ATagFooterBottom">Dashboard</a> | <a href="/nodal-officer" class="ATagFooterBottom">Nodal Officer</a> | <a href="/Refrences" class="ATagFooterBottom">Refrences</a>
                        </p>
                    </div>
                    <div class="footerBottomRight">
                        <p> Copyright © 2022, 
                            <a href="https://www.niti.gov.in/" class="Linkbtn">Niti Aayog</a>
                            , Agriculture and Allied Sectors Vertical
                        </p>
                    </div>
                </div>
            </div>
